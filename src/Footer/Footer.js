        ...
        <div className="row">
          <div className="col-md-5  mt-3 mb-4 mb-md-0">
            ...
            <p className="col-md-8">
              Our mission is to provide a well-rounded education that encourages
              curiosity, creativity, and critical thinking. With a team of
              passionate educators and a supportive community, we strive to help
              each student reach their full potential and prepare for a bright
              future.
            </p>
            ...
            <ul className="list-unstyled m-2">
              ...
              <li className="mb-2">
                <a href="/ContactUs" className="text-dark text-decoration-none">
                  <i className="fa fa-spinner"></i>Contact Us
                </a>
              </li>
            </ul>
          </div>
          <div className="col-md-3  ">
            <div className="mb-4 mt-3">
              ...
              <ul className="list-unstyled">
                <li className="mb-2">
                  <i className="_icon fa fa-graduation-cap text-success" />{" "}
            ...
            <div className="mb-4">
              ...
              <ul className="list-unstyled">
                <li className="mb-2 ">
                  <i className="_icon fa fa-bell text-success" />
            ...
            <div>
              ...
              <ul className="list-unstyled">
                <li className="mb-2">
                  {" "}
                  <i className="_icon fa fa-trophy text-success" />
                  "Merit Recognition Trophy"
                </li>
              </ul>
            </div>
          </div>
